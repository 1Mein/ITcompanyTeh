            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="text-center">Upload Film</h3>
                        <div class="d-flex justify-content-center">
                            <form action="{{route('film.store')}}" method="post" class="mx-auto" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="name" class="form-label">Film name</label>
                                    <input name="name" class="form-control" type="text"
                                           id="name" placeholder="Film name" value="{{old('name')}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="w-100" name="genre_ids[]" id="genres" multiple="multiple">
                                        @foreach($genres as $genre)
                                            <option value="{{$genre->id}}" @if(in_array($genre->id,old('genre_ids')??[])) selected @endif>{{$genre->name}}</option>
                                        @endforeach
                                    </select>
